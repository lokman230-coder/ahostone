...
// v25.0.0 RC20: Merkezi admin yetkilendirmesi.
...
function ao_schema_ensure_v990() {
    ...
    try { db()->exec("INSERT INTO settings(setting_key,setting_value) VALUES ('ahost_version','25.0.0-rc24') ON DUPLICATE KEY UPDATE setting_value=VALUES(setting_value)"); } catch(Throwable $e) {}
}
...
function ao_schema_ensure_v930() {
    ...
    try{ save_setting('ahost_version','25.0.0-rc24'); }catch(Throwable $e){}
}
...
function ao_schema_ensure_v1200() {
    ...
    try{ db()->prepare("INSERT INTO settings(setting_key,setting_value) VALUES('ahost_version','25.0.0-rc24') ON DUPLICATE KEY UPDATE setting_value='25.0.0-rc24'")->execute(); }catch(Throwable $e){}
    $search=[
...
function ao_schema_ensure_v1500() {
    try {
        ...
        db()->exec("INSERT INTO settings(setting_key,setting_value) VALUES ('ahost_version','25.0.0-rc24'),('license_center_enabled','1'),('license_center_v2_enabled','1'),('ai_help_center_enabled','1') ON DUPLICATE KEY UPDATE setting_value=VALUES(setting_value)");
    } catch(Throwable $e) {}
}
...
function ao_license_ensure_v1888() {
    ...
    try {
        ...
        save_setting('license_center_v2_enabled','1'); save_setting('license_offline_first','1'); save_setting('ahost_version','25.0.0-rc24');
    } catch(Throwable $e) {}
}
...
function ao_builder_pro_ensure_schema(){
    ...
    try{ db()->prepare("INSERT INTO settings(setting_key,setting_value) VALUES('ahost_version','25.0.0-rc24'),('builder_pro_3_enabled','1'),('builder_pro_targets','site,admin,customer') ON DUPLICATE KEY UPDATE setting_value=VALUES(setting_value)")->execute(); }catch(Throwable $e){}
}
...
$siteMap = ['' => 'home/index','cart'=>'cart/index','checkout'=>'cart/index','blog'=>'blog/index','domain' => 'domain/index','hosting' => 'products/hosting','vps' => 'products/vps','web-tasarim' => 'products/web-design','sitebuilder'=>'products/sitebuilder','mobilebuilder'=>'products/mobilebuilder','mobil-uygulama'=>'products/mobile-app','dijital-hizmetler'=>'products/digital-services','marketplace'=>'marketplace/index','referanslar'=>'references/index','bilgi-bankasi'=>'knowledge-base/index','knowledge-base'=>'knowledge-base/index','urunler'=>'products/index','products'=>'products/index','seo-analyzer'=>'seo-analyzer/index','domain-checker'=>'domain-checker/index','teklif'=>'quotation','mobilebuilder/download'=>'mobilebuilder-download'];
...
if (preg_match('#^blog/([^/]+)$#', $route, $m)) {
    site_view('blog/post', ['pageTitle'=>'Ahost One Blog', 'slug'=>$m[1]]);
    exit;
}
