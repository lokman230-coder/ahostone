...
?>
<section class="ao-site-content ao-cart-page"><div class="ao-content-shell"><div class="ao-content-hero"><span class="ao-content-kicker">Sepet</span><h1>Sepet ve Sipariş Akışı</h1><p>Ödeme adımına kadar giriş yapmadan ürün, domain ve ek hizmetleri düzenleyebilirsiniz.</p></div>
<?php if(!$cart): ?><div class="ao-content-empty"><p>Sepetiniz boş.</p><a class="ao-content-btn" href="<?= url('urunler') ?>">Ürünleri İncele</a></div><?php else: ?>
