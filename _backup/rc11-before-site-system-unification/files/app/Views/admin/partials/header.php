...
<!-- RC10 Premium SaaS Design System: old CSS remains loaded above, canonical UI layer wins below. -->
<link rel="stylesheet" href="<?= assetv('css/ao-tokens.css') ?>">
<link rel="stylesheet" href="<?= assetv('css/ao-components.css') ?>">
<link rel="stylesheet" href="<?= assetv('css/ao-admin-shell.css') ?>">
<link rel="stylesheet" href="<?= assetv('css/ao-legacy-compat.css') ?>">
</head>
...
<?php endif; ?>
<aside class="ao-sidebar"><div class="ao-brand"><img src="<?= e(ao_brand_logo_url()) ?>" alt="Ahost One" onerror="this.style.display='none';this.nextElementSibling.style.display='inline-flex'"><strong style="display:none">Ahost One</strong><span>v25 RC10</span></div><nav class="ao-nav">
