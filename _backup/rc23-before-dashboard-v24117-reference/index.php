...
function ao_schema_ensure_v990() {
    ...
    try { db()->exec("INSERT INTO settings(setting_key,setting_value) VALUES ('ahost_version','25.0.0-rc21') ON DUPLICATE KEY UPDATE setting_value=VALUES(setting_value)"); } catch(Throwable $e) {}
}
...
function ao_schema_ensure_v930() {
    ...
    try{ save_setting('ahost_version','25.0.0-rc21'); }catch(Throwable $e){}
}
...
function ao_schema_ensure_v1200() {
    ...
    try{ db()->prepare("INSERT INTO settings(setting_key,setting_value) VALUES('ahost_version','25.0.0-rc21') ON DUPLICATE KEY UPDATE setting_value='25.0.0-rc21'")->execute(); }catch(Throwable $e){}
    $search=[
...
function ao_schema_ensure_v1500() {
    try {
        ...
        db()->exec("INSERT INTO settings(setting_key,setting_value) VALUES ('ahost_version','25.0.0-rc21'),('license_center_enabled','1'),('license_center_v2_enabled','1'),('ai_help_center_enabled','1') ON DUPLICATE KEY UPDATE setting_value=VALUES(setting_value)");
    } catch(Throwable $e) {}
}
...
function ao_license_ensure_v1888() {
    ...
    try {
        ...
        save_setting('license_center_v2_enabled','1'); save_setting('license_offline_first','1'); save_setting('ahost_version','25.0.0-rc21');
    } catch(Throwable $e) {}
}
...
function ao_builder_pro_ensure_schema(){
    ...
    try{ db()->prepare("INSERT INTO settings(setting_key,setting_value) VALUES('ahost_version','25.0.0-rc21'),('builder_pro_3_enabled','1'),('builder_pro_targets','site,admin,customer') ON DUPLICATE KEY UPDATE setting_value=VALUES(setting_value)")->execute(); }catch(Throwable $e){}
}
