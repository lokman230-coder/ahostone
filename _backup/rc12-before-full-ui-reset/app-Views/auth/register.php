...
<style>.auth-selected-product{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin:16px 0;padding:14px;border:1px solid #dbeafe;border-radius:14px;background:#eff6ff}.auth-selected-product strong{color:#0f172a}.auth-selected-product span{color:#64748b;font-size:12px}.auth-selected-product a{margin-left:auto;font-size:12px;font-weight:900}</style>
