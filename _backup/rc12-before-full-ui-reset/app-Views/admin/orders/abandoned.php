...
<style>
.abandoned-kpi-grid-v2410{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin:18px 0}.abandoned-kpi-card{border:1px solid #e2e8f0;border-radius:22px;padding:20px;background:linear-gradient(180deg,#fff,#f8fbff);box-shadow:0 16px 40px rgba(15,23,42,.07)}.abandoned-kpi-card span{display:block;color:#64748b;font-weight:900}.abandoned-kpi-card strong{display:block;font-size:30px;color:#0f172a;margin:8px 0}.abandoned-kpi-card em{color:#2563eb;font-style:normal;font-weight:900}.abandoned-filter-pills,.abandoned-rules{display:flex;gap:10px;flex-wrap:wrap}.abandoned-filter-pills a,.abandoned-rules span{padding:10px 12px;border-radius:999px;border:1px solid #dbe7f5;background:#f8fafc;font-weight:900;text-decoration:none;color:#0f172a}.abandoned-filter-pills a.active{background:#2563eb;color:#fff;border-color:#2563eb}.abandoned-table-card-v2410 .ao-action-row{display:flex;gap:7px;flex-wrap:wrap}@media(max-width:980px){.abandoned-kpi-grid-v2410{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:640px){.abandoned-kpi-grid-v2410{grid-template-columns:1fr}}
</style>
