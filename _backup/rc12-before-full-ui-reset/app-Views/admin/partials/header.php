...
<script defer src="<?= assetv('js/ao-ui.js') ?>"></script>
...
<?php endif; ?>
<aside class="ao-sidebar"><div class="ao-brand"><img src="<?= e(ao_brand_logo_url()) ?>" alt="Ahost One" onerror="this.style.display='none';this.nextElementSibling.style.display='inline-flex'"><strong style="display:none">Ahost One</strong><span>v25 RC11</span></div><nav class="ao-nav">
