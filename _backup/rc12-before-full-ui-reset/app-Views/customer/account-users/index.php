...
<style>.client-grid.two{display:grid;grid-template-columns:1.1fr .9fr;gap:18px}.client-card{background:#fff;border:1px solid #e2e8f0;border-radius:20px;padding:20px;margin-bottom:18px;box-shadow:0 10px 30px rgba(15,23,42,.06)}.client-form{display:grid;gap:12px}.client-form label{font-weight:800;color:#0f172a}.client-form input,.client-form select{width:100%;box-sizing:border-box;border:1px solid #dbe4f0;border-radius:12px;padding:12px;margin-top:6px}.role-list{display:grid;gap:10px}.role-list div{border:1px solid #e2e8f0;border-radius:14px;padding:12px;background:#f8fafc}.role-list small{display:block;color:#64748b;margin-top:4px}.table-wrap{overflow:auto}.client-table{width:100%;border-collapse:collapse}.client-table th,.client-table td{padding:12px;border-bottom:1px solid #e2e8f0;text-align:left}.status{padding:5px 9px;border-radius:999px;background:#e2e8f0;font-weight:900}.status.active{background:#dcfce7;color:#166534}.status.invited{background:#dbeafe;color:#1d4ed8}.status.disabled{background:#fee2e2;color:#991b1b}.log-list{display:grid;gap:8px;padding-left:18px}.log-list small{color:#64748b}@media(max-width:900px){.client-grid.two{grid-template-columns:1fr}}</style>
