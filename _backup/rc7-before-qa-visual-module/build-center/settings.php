...
?>
<div class="premium-page build-center-pro"><div class="premium-page-head"><div><h2>Build Center Ayarları</h2><p>Yerel veya uzak build node ayarları.</p></div><a class="btn ghost" href="<?= url('admin/build-center') ?>">← Dashboard</a></div><section class="premium-card"><h3>Build Center Ayarları</h3><p>Bu ekran v16.5.0 Build Center Pro kalıcı mimarisi için hazırlandı. Yönetim, log ve durum kayıtları buradan takip edilir.</p><div class="env-list"><?php foreach($env as $e): ?><div class="env-row"><span><?= e($e[0]) ?></span><b><?= e($e[1]) ?></b><em class="pill green"><?= e($e[2]) ?></em></div><?php endforeach; ?></div></section></div>